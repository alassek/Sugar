...
(function() {
  ...
  extend(array, false, false, {
    ...
    /***
     *
     * @method Array.wrap(<obj>)
     * @returns Array
     * @short Wraps <obj> in an array unless <obj> is already an array.
     * @extra If <obj> is null or undefined, returns an empty array.
     * @example
     *
     *   Array.wrap(1)       -> [1]
     *   Array.wrap('test')  -> ['test']
    ...
    'wrap': function (obj) {
      if ( obj == null ) return [];
      if ( isClass(obj, 'Array') ) return obj;
      return [obj];
    }
